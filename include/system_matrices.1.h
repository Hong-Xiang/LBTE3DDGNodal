...
namespace dgn {
	...
	public:
		...
		const matrix_t lift_matrix(InterfaceDirection idr) const { return lift_matrices_.at(static_cast<size_t>(idr)); }
		const matrix_t flux_matrix(InterfaceDirection idr) const { return flux_matrices_.at(static_cast<size_t>(idr)); }
	...
	public:
		...
		const matrix_t lift_matrix(InterfaceDirection dir) const {
		...
		const matrix_t flux_matrix(InterfaceDirection dir) const {
