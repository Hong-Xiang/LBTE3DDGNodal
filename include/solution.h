...
namespace discontinues_galerkin_nodal_solver {
  class Solution {
  public:
    Solution(const Mesh& mesh, const SystemMatrix& system);
  ...
  class AnalyticalSolutionMeshCoordinates : public Solution{
  public:
    AnalyticalSolutionMeshCoordinates(const MeshWithCoordinate& mesh,
